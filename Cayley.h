...
public:
	 ...
	 * The constructor.
	 */
	Cayley_Model(int problem_size, int sel_size, double * lower_theta_bound, double * upper_theta_bound);
...
private:
	 ...
	 */
    double CalculateThetaParameter(int*consensus, int ** samples, int cases_num);
	 ...
	 */
	double CalculatePsiConstants(double theta, double* psi);
